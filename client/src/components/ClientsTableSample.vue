    ...
    <div>
        ...
        >
            <template slot-scope="props">
                ...
                <b-table-column label="Company" field="company" sortable>{{ props.row.company }}</b-table-column>
                <b-table-column label="City" field="city" sortable>{{ props.row.city }}</b-table-column>
